window.questionBankData = [
  {
    ...
    "options": [
      ...
      "Urban stakeholders who both generate and use data",
  ...
  },
  {
    ...
    "options": [
      ...
      "Allows observation of trends and variations",
      "Reduces data volume",
  ...
  },
  {
    ...
    "options": [
      ...
      "Continuous inflow of data with minimal latency",
  ...
  },
  {
    ...
    "options": [
      "Satellite imagery",
      "Operational details of mass transit systems",
      "Census statistics",
  ...
  },
  {
    ...
    "options": [
      ...
      "Analysis of systematically collected data to support actions",
      "Political intuition",
      "Paper-based records"
    ],
    "correctIndices": [
  ...
  },
  {
    ...
    "options": [
      ...
      "Depends entirely on sensors",
      "Actively involves citizens in data generation",
  ...
  },
  {
    ...
    "options": [
      "Lack of urban land",
      "Unequal access to internet and digital skills",
  ...
  },
  {
    ...
    "options": [
      ...
      "Enable real-time monitoring of multiple urban systems",
      "Replace municipal departments",
  ...
  },
  {
    ...
    "options": [
      "Manual data updates",
      "Limited datasets",
      "Automated data pipelines and legal backing",
  ...
  },
  {
    ...
    "options": [
      ...
      "Enabling interoperable and scalable urban digital services",
      "Replacing municipal staff",
      "Limiting citizen interaction"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Higher normal forms always increase performance",
      "A deletion anomaly occurs when deleting a record intentionally removes other data.",
      "An update anomaly occurs when data is stored in single place."
    ],
    "correctIndices": [
      0
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "The data schema must remain fixed and highly normalized",
      "The goal is to reduce all data to a single unified table for faster queries"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Balanced Access, Structured Storage, Encrypted Consistency",
      "Backup Availability, Stable Schema, Exact Consistency",
  ...
  },
  {
    ...
    "options": [
      ...
      "It enforces relationships between tables using keys",
      "It supports only spatial datasets",
      "It does not require structured queries"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "APIs abstract internal database structure and expose data via controlled interfaces",
      "APIs require SQL from clients so that data can be returned",
      "APIs eliminate authentication"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "It exposes database credentials to users",
      "It centralizes logic and improves security",
  ...
  },
  {
    ...
    "options": [
      ...
      "Filtering results based on an aggregate condition",
  ...
  },
  {
    ...
    "options": [
      ...
      "SELECT road_id FROM traffic_observations GROUP BY road_id HAVING COUNT(obs_id) > 1;",
      "SELECT road_id FROM road_segments GROUP BY road_id HAVING COUNT(obs_id) > 1;",
      "SELECT road_id FROM traffic_observations HAVING COUNT(obs_id) > 1;"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Global data are vulnerable to inadvertent changes by functions.",
      "External data structure changes require revision of many dependent functions.",
      "Data is fully encapsulated and cannot be accessed directly by functions."
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Array and List can store elements of different data types.",
      "Dictionary is mutable and stores data as key-value pairs, while Set does not allow duplicate elements.",
      "Tuple and Set both preserve insertion order."
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "JSON supports nested and hierarchical structures",
      "CSV supports key-value pairs",
      "CSV preserves data types automatically"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Bridging database tables with programming objects",
  ...
  },
  {
    ...
    "options": [
      ...
      "df[\"population\"] = df[\"population\"].interpolate() df = df.reset_index(drop=True)",
      "df = df.dropna() df = df.set_index(\"population\")",
      "df[\"population\"] = df[\"population\"].fillna(0) df = df.reset_index()"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "df[\"area_sq_m\"].fillna(0)",
      "df[\"area_sq_m\"].fillna(df[\"area_sq_m\"].median())",
      "df.dropna()"
    ],
    "correctIndices": [
      2
  ...
  },
  {
    ...
    "options": [
      ...
      "Database abstraction and object-based interaction",
      "Automatic indexing of tables"
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "df.groupby(\"PM25\").count().plot()",
      "plt.scatter(df.index, df[\"PM25\"])"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "df.groupby(\"Area\")[\"PM25\"].mean().plot(kind=\"bar\")",
      "df.groupby(\"PM25\")[\"Area\"].mean().plot()",
      "df[\"PM25\"].mean().plot(kind=\"bar\")"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "df[\"value\"] = (df[\"value\"] - df[\"value\"].min()) / df[\"value\"].max()",
  ...
  },
  {
    ...
    "options": [
      ...
      "To uniformly redistribute variance across all features.",
      "To make sure patterns becomes clearer and capture maximum variance.",
      "To eliminate feature correlation completely."
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "A model built only using qualitative assumptions",
      "A model that cannot be validated or tested",
      "A model with fully transparent parameters and equations"
    ],
    "correctIndices": [
      0
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Random Forest model predicting peak-hour traffic volume",
      "Principal Component Analysis (PCA) applied to urban environmental indicators",
      "Logistic Regression estimating the probability of modal shift"
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "High VIF indicates that the predictors are strongly related to the dependent variable.",
      "Removing the dependent variable from the model will reduce VIF values.",
      "Even though the model fit is good, the individual regression coefficients may not be reliably interpreted due to multicollinearity among predictors."
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "For linear, continuous data without extreme outliers",
  ...
  },
  {
    ...
    "options": [
      ...
      "Measure the correlation between land use mix and property prices",
      "Predict traffic congestion levels using multiple independent variables",
      "Compare the median pedestrian satisfaction levels across three different street design types when data is not normally distributed"
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "To improve data preprocessing by removing noise from the dataset",
  ...
  },
  {
    ...
    "options": [
      ...
      "A- Prediction; B- Clustering; C- Scenario Analysis",
      "A- Scenario Analysis; B- Clustering; C- Prediction",
      "A- Clustering; B- Prediction; C- Scenario Analysis"
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "It visually displays pairwise relationships among variables, helping identify linear/non -linear patterns, clusters, outliers, and class-wise heterogeneity.",
      "It reduces high-dimensional data into principal components to maximize explained variance.",
      "It automatically selects the best predictive model based on feature interactions."
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "The attribute traffic volume is most likely to be selected as root node as it has the highest information gain among the three attributes.",
      "The attribute commercial activity is most likely to be selected as root node as it has the lowest information gain among the three attributes.",
      "The attribute traffic volume is least likely to be selected as root node as it has the lowest weighted entropy among the three attributes."
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Decision trees are prone to overfitting and instability, which can be reduced using pruning and ensemble methods like Random Forests.",
      "Decision trees cannot handle categorical data, which is addressed by converting all features to numerical values.",
      "Decision trees only work fo r regression problems, which is addressed using classification techniques."
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "max_depth - determines the depth of each tree",
      "subsample - specifies the fraction of training instances used for each tree",
  ...
  },
  {
    ...
    "options": [
      ...
      "Bagging trains multiple models on bootstrap samples in parallel, Random Forest additionally selects random subsets of f eatures at each split, and Boosting trains models sequentially to reduce previous errors.",
      "Bagging and Boosting both use feature randomness at each split, while Random Forest uses the full dataset without sampling.",
      "Random Forest and Boosting both rely only on averaging predictions, while Bagging uses majority voting."
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "To allow some margin violations and misclassifications for noisy data.",
      "To use only perfectly separable data",
  ...
  },
  {
    ...
    "options": [
      ...
      "It assigns labels to data points without using similarity information",
      "It removes unlabeled data before classification.",
      "It iteratively spreads labels from labeled nodes to unlabeled nodes based on data similarity"
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Probability estimation, K-Means",
      "Gradient descent, Principal Component Analysis",
      "Regression analysis, K-Nearest Neighbours"
    ],
    "correctIndices": [
      0
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "An unsupervised data mining method used to identify patterns and frequent co -occurring relationships among variables in large datasets",
      "A clustering algorithm that groups data based on Euclidean distance",
      "A regression technique used to predict continuous values"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "A - Average Linkage, B - Single Linkage, C - Ward's Linkage",
      "A - Complete Linkage, B - Average Linkage, C - Single Linkage",
      "A - Single Linkage, B - Ward's Linkage, C - Average Linkage"
    ],
    "correctIndices": [
      0
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "A point whose epsilon-neighbourhood contains at least MinPts points",
      "A point that is not reachable from any other point within epsilon distance",
      "A point that connects two clusters together"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Statements B and D are true; Statements A and C are false",
  ...
  },
  {
    ...
    "options": [
      ...
      "PCA constructs orthogonal components as linear combinations of the original variables, where the first component captures the maximum variance across the correlated variables.",
      "PCA converts correlated variables into independent categorical groups based on their correlation strength.",
      "PCA ranks variables based on their correlation with temperature and removes those with lower correlations."
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "It groups points by minimizing within-cluster variance similar to Ward's method.",
      "It identifies clusters by iteratively moving data points toward regions of higher data density.",
      "It forms clusters based only on the farthest distance between data points."
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Three clusters are inappropriate because silhouette values close to zero indicate that K-means has completely failed.",
      "Five clusters are better because silhouette score measures only cluster compactness, not separation.",
      "Three clusters are likely appropriate because the elbow occurs at k = 3, and the higher silhouette score indicates better separation, although some neighbourhoods may lie near cluster boundaries."
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "The number of decision boundaries required to separate different classes",
  ...
  },
  {
    ...
    "options": [
      ...
      "Computing the partial derivatives of the loss function with respect to weights and biases",
  ...
  },
  {
    ...
    "options": [
      ...
      "It replaces the loss function in deep learning models",
      "It increases the number of hidden layers in a neural network",
      "It explains the contribution of each feature to a model's prediction using Shapley values"
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Because neural networks always converge to a single global minimum",
      "Due to nonlinear activation functions, multiple layers, and a large number of parameters",
      "Due to the absence of optimization algorithms"
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Both CNNs and RNNs are used only for image classification",
      "CNNs and RNNs are used only for unsupervised learning",
      "CNNs are used for spatial data, while RNNs are used for sequential/temporal data"
    ],
    "correctIndices": [
      3
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "To write, compile, and upload programs to microcontrollers",
      "To design hardware circuits only",
      "To replace embedded systems"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Continuous high-speed rotation without control",
      "Operating only at fixed speeds",
      "Producing linear motion without any rotation"
    ],
    "correctIndices": [
      0
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "Detecting sound frequency variations in the environment",
      "Sensing changes in infrared radiation from warm objects",
  ...
  },
  {
    ...
    "options": [
      ...
      "A method to draw maps manually",
      "A technique used to design computer hardware components",
  ...
  },
  {
    ...
    "options": [
      ...
      "The CSV file must contain spatial coordinates",
      "Both datasets must contain a common matching field",
      "The shapefile must be converted into raster format"
    ],
    "correctIndices": [
      2
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "When a one-to-many relationship exists between tables",
      "When spatial data needs to be visualized",
      "When converting coordinate systems"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      "To create a polygon grid for aggregating point data",
      "To remove spatial outliers",
      "To calculate distance automatically"
    ],
    "correctIndices": [
      1
    ],
  ...
  },
  {
    ...
    "options": [
      "Hardware design",
      "Desktop-only spatial analysis",
      "Image editing",
      "Web GIS, cloud-based mapping and data access"
    ],
    "correctIndices": [
      3
    ],
